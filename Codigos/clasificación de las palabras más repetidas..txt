...
if __name__ == "__main__":
    ...
    display_word_ranking(my_documents)
    ...
    for word, positions in inverted_index.items():
        positions_info = [(document_line, word_position) for document_line, word_position in positions]
        all_word_positions[word] = positions_info

    print("Ubicación de todas las palabras:")
    for word, positions_info in all_word_positions.items():
        print(f"{word}:")
